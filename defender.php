...
<ul>
	...
	<li><a href="defender.php" style="color: red;">Log Out</a></li>
...
<br><br>
		...
		<script>
			function savedata(){
				if(window.confirm("Do you want to buy these palyers?")){
					window.location.assign("savedatadefender.php?id1="+selarray[0][2]+"&id2="+selarray[1][2]+"&id3="+selarray[2][2]+"&id4="+selarray[3][2]+"&id5="+selarray[4][2]);
				}
			}
		...
		<?php
		    ...
		    $query = $db->query("SELECT * FROM player WHERE position = 'D' ORDER BY prize DESC");
