...
<ul>
	...
	<li><a href="user-profile.php?logout='1'" style="color: red;">Log Out</a></li>
	...
	<br><br>	<h3>Choose Striker</h3>
		...
		<script>
			function savedata(){
				if(window.confirm("Do you want to buy these palyers?")){
					window.location.assign("savedata.php?id1="+selarray[0][2]+"&id2="+selarray[1][2]+"&id3="+selarray[2][2]);
				}
			}
		...
		<?php
		    ...
		    $query = $db->query("SELECT * FROM player WHERE position = 'A' ORDER BY prize DESC");
