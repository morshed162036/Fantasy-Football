...
<ul>
	...
	<li><a href="winer.php" style="color: red;">Log Out</a></li>
...
<div class="content">
    <table>
        ...
        $a=$_SESSION['username'];
		$sql="SELECT teamname,sum(point) as point FROM point group by teamname order by point DESC";
		$result=$con->query($sql);

		if($result->num_rows >0){
			while ($row=$result->fetch_assoc()) {
                echo "<tr><td>".$row["teamname"]."</td><td>".$row["point"]."</td></tr>";
			}
			echo "</table>";
		}
		else{
