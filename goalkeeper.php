...
<ul>
	...
	<li><a href="goalkeeper.php" style="color: red;">Log Out</a></li>
	...
	<br><br>	<h3>Choose Goalkeeper</h3>
		...
		<script>
			function savedata(){
				if(window.confirm("Do you want to buy these palyers?")){
					window.location.assign("savedatagole.php?id1="+selarray[0][2]+"&id2="+selarray[1][2]);
				}
			}
		...
		<?php
		    ...
		    $query = $db->query("SELECT * FROM player WHERE position = 'G' ORDER BY prize DESC");
